...
const ACTIVITIES = [
  ...
  "Couture / Mode",
  "Boutique gÃ©nÃ©rale",
  "TÃ©lÃ©phonie / Informatique",
  "Freelance / Services",
  "Agriculture / MaraÃ®chage",
  "Artisanat",
  "Autre",
];
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.activity || !form.city) {
      setError("Veuillez sÃ©lectionner votre activitÃ© et votre ville.");
      return;
    }
    setError("");
    setLoading(true);
    ...
    try {
      ...
      // Email par dÃ©faut si non fourni (phone@fadima.app)
      ...
      if (signUpError) {
        if (signUpError.message.includes("already registered")) {
          setError("Ce compte existe dÃ©jÃ . Connectez-vous.");
        } else {
      ...
      if (data.user) {
        ...
        const defaultExpenseCategories = [
          ...
          { name: "Ã‰lectricitÃ©", type: "expense" as const, color: "#eab308" },
      ...
      <div className="bg-white rounded-2xl shadow-elevated p-8 border border-gray-100">
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">
            {step === 1 ? "CrÃ©er votre compte ðŸš€" : "Votre business ðŸª"}
          </h1>
          <p className="text-gray-500 text-sm">
            {step === 1 ? "Ã‰tape 1 sur 2 â€” Informations personnelles" : "Ã‰tape 2 sur 2 â€” Votre activitÃ©"}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="activity" className="input-label">
                Votre activitÃ© <span className="text-red-500">*</span>
              </label>
              <select
                id="activity"
                className="select"
